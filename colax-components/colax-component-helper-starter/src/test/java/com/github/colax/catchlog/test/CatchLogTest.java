package com.github.colax.catchlog.test;

import com.github.colax.catchlog.CatchLogAspect;
import com.github.colax.helper.HelperAutoConfiguration;
 ...
 *
 */
@SpringBootTest(classes = {HelperAutoConfiguration.class, Demo.class, CatchLogAspect.class, Application.class})
